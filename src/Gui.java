...
public class Gui {
    ...
    final static Icon whitePawnIco = new ImageIcon(new ImageIcon("Pics\\White\\Pawn.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon whiteKingIco = new ImageIcon(new ImageIcon("Pics\\White\\King.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon whiteKnightIco = new ImageIcon(new ImageIcon("Pics\\White\\Knight.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon whiteQueenIco = new ImageIcon(new ImageIcon("Pics\\White\\Queen.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon whiteRookIco = new ImageIcon(new ImageIcon("Pics\\White\\Rook.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon whiteBishopIco = new ImageIcon(new ImageIcon("Pics\\White\\Bishop.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
     
    final static Icon blackPawnIco = new ImageIcon(new ImageIcon("Pics\\Black\\Pawn.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon blackKingIco = new ImageIcon(new ImageIcon("Pics\\Black\\King.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon blackKnightIco = new ImageIcon(new ImageIcon("Pics\\Black\\Knight.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon blackQueenIco = new ImageIcon(new ImageIcon("Pics\\Black\\Queen.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon blackRookIco = new ImageIcon(new ImageIcon("Pics\\Black\\Rook.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    final static Icon blackBishopIco = new ImageIcon(new ImageIcon("Pics\\Black\\Bishop.png").getImage().getScaledInstance(iconSize, iconSize, Image.SCALE_DEFAULT));
    ...
    public final void initializeGui() {
        ...
        tools.add(newButton); //create new game
        tools.add(new JButton("Save")); // TODO - add functionality!
        tools.add(new JButton("Restore")); // TODO - add functionality!
        tools.addSeparator();
        tools.add(resignButton); //resign the game
        ...
        for (int i = 0; i < 8; i++) {
            chessBoard.add(new JLabel(letters.substring(i, i + 1), SwingConstants.CENTER)); // adding leters centered , substring used for spliting strings
        }
        for (int i = 7; i >= 0; i--) {
            for (int j = 0; j < 8; j++) {    
                if(j==0){
    ...
    private void resign() {
        ...
        int returnValue = JOptionPane.showOptionDialog(null, "You want to leave?", "resign",
